                    ...
                    if scene != "":
                        ...
                        while (index + multi + 3) < len(new_img_names):
                            ...
                            for i in range(multi):
                                ...
                                events_before_names = [os.path.join(event_folder, event_names[i]) for i in
                                                       range(start_ind, gt_ind)]
                                events_after_names = [os.path.join(event_folder, event_names[i]) for i in
                                                      range(gt_ind, end_ind)]
                                try:
                                    events_0t = EventSequence.from_npz_files(events_before_names, h, w, hsergb=True,
                                                                             size=[0, 0, h, w])
                                except:
                                    events_0t = None
                                try:
                                    events_t1 = EventSequence.from_npz_files(events_after_names, h, w, hsergb=True,
                                                                             size=[0, 0, h, w])
                                except:
                                    events_t1 = None
